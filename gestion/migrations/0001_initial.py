    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razon_social', models.CharField(max_length=255, unique=True)),
                ('activo', models.BooleanField(default=True)),
                ('rif', models.CharField(blank=True, max_length=20, unique=True, verbose_name='R.I.F.')),
                ('banco_pago', models.CharField(blank=True, max_length=100, verbose_name='Banco')),
                ('numero_cuenta', models.CharField(blank=True, max_length=20, verbose_name='Número de Cuenta')),
                ('tipo_cuenta', models.CharField(blank=True, choices=[('COR', 'Corriente'), ('AHO', 'Ahorros')], max_length=3)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.BooleanField(default=True)),
                ('rif', models.CharField(blank=True, db_index=True, max_length=20, verbose_name='R.I.F.')),
                ('banco_pago', models.CharField(blank=True, max_length=100, verbose_name='Banco')),
                ('numero_cuenta', models.CharField(blank=True, max_length=20, verbose_name='Número de Cuenta')),
                ('tipo_cuenta', models.CharField(blank=True, choices=[('COR', 'Corriente'), ('AHO', 'Ahorros')], max_length=3)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona_contacto_sede', models.CharField(blank=True, max_length=100, verbose_name='Persona Contacto (Sede)')),
                ('activo', models.BooleanField(default=True)),
